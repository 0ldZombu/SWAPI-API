...
class BaseClass:
    ...
    def __init__(self, url="http://swapi.py4e.com/api", timeout=1):
        self.url = url
...
class RequestPage(BaseClass):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[0]}", timeout=self.timeout)
                assert responce.status_code == 200
    ...
    def people_request_ID_1(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[0]}/1", timeout=self.timeout)
                assert responce.status_code == 200
    ...
    def planets_page(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[1]}", timeout=self.timeout)
                assert responce.status_code == 200
                assert responce.json().get('count') != 0
            except AssertionError:
                return pytest.fail()
    ...
    def planets_request_ID_1(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[1]}/1", timeout=self.timeout)
                assert responce.status_code == 200
    ...
    def films_page(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[2]}", timeout=self.timeout)
                assert responce.status_code == 200
                assert responce.json().get('count') != 0
            except AssertionError:
                return pytest.fail()
    ...
    def films_request_ID_1(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[2]}/1", timeout=self.timeout)
                assert responce.status_code == 200
    ...
    def species_page(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[3]}", timeout=self.timeout)
                assert responce.status_code == 200
                assert responce.json().get('count') != 0
            except AssertionError:
                return pytest.fail()
    ...
    def species_request_ID_1(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[3]}/1", timeout=self.timeout)
                assert responce.status_code == 200
    ...
    def vehicles_page(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[4]}", timeout=self.timeout)
                assert responce.status_code == 200
                assert responce.json().get('count') != 0
            except AssertionError:
                return pytest.fail()
    ...
    def vehicles_request_ID_4(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[4]}/4", timeout=self.timeout)
                assert responce.status_code == 200
    ...
    def starships_page(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[5]}", timeout=self.timeout)
                assert responce.status_code == 200
                assert responce.json().get('count') != 0
            except AssertionError:
                return pytest.fail()
    ...
    def starships_request_ID_9(self, list_endpoints):
        ...
        with allure.step(
            ...
            try:
                responce = requests.get(
                    f"{list_endpoints[5]}/9", timeout=self.timeout)
                assert responce.status_code == 200
                assert responce.json().get(
